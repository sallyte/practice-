...
# print('바다의 물결은 남해 앞바다' + southOceanWave + 'm, 동해 앞바다' + 'm, 서해 앞바다' + westOceanWave + 'm 높이로 일겠습니다.')
# print('지금까지' + dateData + ' ' + dayData + '요일 날씨 예보였습니다.')

print(f'{dayData} 요일인 {dateData} 의 아침 최저 기온은 {lowestTemp} 도, 낮 최고 기온은 {highestTemp} 도로 예보됐습니다.')
print(f'비올 확률은 {rainingPercent}%이고, 미세먼지는 {fineDustStatus} 수준일 것으로 예상됩니다.')
print(f'일출 시간은 {sunriseTime}이고, 일몰 시간은 {sunsetTime}입니다.') 
print(f'바다의 물결은 남해 앞바다 {southOceanWave}m, 동해 앞바다 {eastOceanWave}m, 서해 앞바다 {westOceanWave}m 높이로 일겠습니다.')
print(f'지금까지 {dateData} {dayData} 요일 날씨 예보였습니다.')
